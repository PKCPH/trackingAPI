...
{
    public partial class matchNameChanghe : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchTeams_Matches_GamematchId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("15a93328-4878-4f47-ac60-41aeb1830bb0"), 1000, "", "123456", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchTeams_GamematchId",
                table: "MatchTeams",
                column: "GamematchId");
